...
parser.add_argument('--save_and_sample_every', type=int, default=150)
...
if __name__ == "__main__":
    ...
    path_run_dir = Path.cwd() / 'runs' / 'VQVAE'/ str(current_time)
    ...
    #     use_attention='none',
    # )
    # model.vqvae.load_pretrained(Path('/home/zyl/working/202406_01/runs/VQVAE/2024_01_05_200333/epoch=114-step=23000.ckpt'))
    # # model.load_pretrained(Path.cwd()/'/home/zyl/working/202406_01/runs/VQVAE/2024_01_05_200333/epoch=114-step=23000.ckpt')
    model=VQVAE.load_from_checkpoint(checkpoint_path='/home/zyl/working/202406_01/runs/VQVAE/2024_01_05_200333/epoch=114-step=23000.ckpt')
    ...
    # ---------------- Execute Training ----------------
    trainer.fit(model, datamodule=dm,ckpt_path='/home/zyl/working/202406_01/runs/VQVAE/2024_01_05_200333/epoch=114-step=23000.ckpt')
